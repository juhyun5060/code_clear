...
class selectionGUI:
    def __init__(self):
        ...
        # button(DECODING)
        button_decoding = tkinter.Button(text="DECODING", width=12, foreground="#ffffff", font=("roboto", "15"), background="#000000",
        ...
        label_img = tkinter.Label(image=right_image)
        label_img.place(x=520, y=120)

        # button(ENCODING)
        button_encoding = tkinter.Button(text="ENCODING", width=12, foreground="#ffffff", font=("roboto", "15"),
